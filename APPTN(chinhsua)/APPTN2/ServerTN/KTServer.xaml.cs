    ...
    public partial class KTServer : Window
    {
        ...
        private void btnStartQuiz_Click(object sender, RoutedEventArgs e)
        {
            ...
            foreach (var session in clientSessions.Values)
            {
                try
                {
                    ...
                    Log($"Gửi START đến {session.Socket.RemoteEndPoint}");
                    SendQuestionToClient(session);
                }
                catch (Exception ex)
                {
            ...
            Log("✅ Quiz đã bắt đầu.");
            btnStartQuiz.IsEnabled = false; // Disable after starting
        }
        ...
        private void btnStopServer_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                try { listener?.Close(); } catch { listener = null; }
        ...
        {
            var questions = new List<Tuple<string, string, string, string, string, string, int>>();
